                ...
                <div className="mx-auto grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 lg:gap-8">
                    ...
                    <div className="order-2 lg:order-none">
                        ...
                        {isCurrentActivityInSelection && (
                            <div className="mb-4 flex w-full flex-wrap items-center gap-2 rounded-lg bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-700 border border-emerald-100 sm:flex-nowrap">
                                ...
                                <button
                                    ...
                                    onClick={(e) => {
                                        ...
                                        if (!id) return
                                        onRemoveActivity && onRemoveActivity(id)
                                    }}
                                    className="sm:ml-auto inline-flex items-center rounded-md bg-white px-2.5 py-1 text-[11px] font-semibold text-red-600 border border-red-200 hover:bg-red-50 transition-colors"
                                >
