...
export default function BookingConfirmation({ onContinueBrowsing, onGoToCart, onBack, onForward, canGoBack, canGoForward, hideHeaderFooter = false }) {
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <div className="max-w-2xl w-full">
                ...
                <div className="text-center mb-6 sm:mb-8">
                    <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">Item Added to Your Cart</h1>
                    <p className="text-sm sm:text-base text-slate-600 px-2">Review your selected trip details or continue exploring unforgettable experiences.</p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <button
                        ...
                        className="flex-1 py-2.5 sm:py-3 px-4 sm:px-6 border-2 border-slate-300 text-slate-700 rounded-lg font-semibold hover:bg-slate-50 transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
                    >
                    ...
                    <button
                        onClick={onGoToCart}
                        className="flex-1 py-2.5 sm:py-3 px-4 sm:px-6 bg-primary-brown text-white rounded-lg font-semibold hover:bg-primary-dark transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
                    >
                        <svg width="16" height="16" className="sm:w-[18px] sm:h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
